...
static func excluded_functions() -> PackedStringArray:
	return ClassDB.class_get_method_list("Object").map(CallableDoubler.map_func_name).filter(
		func(name: String) -> bool: return !CallableDoubler.callable_functions().has(name)
	)
...
func bind(
	...
	# save
	var bind_values: Array = GdArrayTools.filter_value(
...
func rpc(
	...
	var args: Array = GdArrayTools.filter_value(
		[arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9],
		GdObjects.TYPE_VARARG_PLACEHOLDER_VALUE
	)
	match args.size():
		...
		1:
			_cb.rpc(args[0])
		2:
			_cb.rpc(args[0], args[1])
		3:
			_cb.rpc(args[0], args[1], args[2])
		4:
			_cb.rpc(args[0], args[1], args[2], args[3])
		5:
			_cb.rpc(args[0], args[1], args[2], args[3], args[4])
		6:
			_cb.rpc(args[0], args[1], args[2], args[3], args[4], args[5])
		7:
			_cb.rpc(args[0], args[1], args[2], args[3], args[4], args[5], args[6])
		8:
			_cb.rpc(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7])
		9:
			_cb.rpc(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8])
		10:
			_cb.rpc(
				args[0],
				args[1],
...
func rpc_id(
	...
	match args.size():
		0:
			_cb.rpc_id(peer_id)
		1:
			_cb.rpc_id(peer_id, args[0])
		2:
			_cb.rpc_id(peer_id, args[0], args[1])
		3:
			_cb.rpc_id(peer_id, args[0], args[1], args[2])
		4:
			_cb.rpc_id(peer_id, args[0], args[1], args[2], args[3])
		5:
			_cb.rpc_id(peer_id, args[0], args[1], args[2], args[3], args[4])
		6:
			_cb.rpc_id(peer_id, args[0], args[1], args[2], args[3], args[4], args[5])
		7:
			_cb.rpc_id(peer_id, args[0], args[1], args[2], args[3], args[4], args[5], args[6])
		8:
			_cb.rpc_id(
				peer_id, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]
			)
		9:
			_cb.rpc_id(
				peer_id,
