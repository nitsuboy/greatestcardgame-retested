...
func _enable_plugin() -> void:
	...
	add_custom_type("WorldRunner", "Node", preload("res://addons/truco/core/ecs/world_runner.gd"), preload("res://addons/truco/icons/world.svg"))
	add_custom_type("SystemNode", "Node", preload("res://addons/truco/core/ecs/system_node.gd"), preload("res://addons/truco/icons/systemnode.svg"))
	add_custom_type("DropZone", "Node2D", preload("res://addons/truco/core/zone/drop_zone.gd"),preload("res://addons/truco/icons/zone.svg"))
